...
public abstract class Personnage extends GravityElement {
	...
	public void initElement(Element data)
	{
		...
		{
			myTextures.put(pos, new ArrayList<>());
			myPixmaps.put(pos, new ArrayList<>());
		}
		...
		setTextureList(new ArrayList<Texture>(myTextures.get(myLastPosition)), new ArrayList<>(myPixmaps.get(myLastPosition)));
	}
	...
	private void updatePersoPos()
	{
		...
		{
			myLastPosition = pos;
			ArrayList<Texture> textureToLoad = new ArrayList<>(myTextures.get(pos));
